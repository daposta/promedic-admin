...
export class Globals {
  HOST_URL = "http://151.236.217.130:8009"; // 'http://0.0.0.0:8002'; //
  ...
  RESPONDER_DOCS_LISTING_URL = this.HOST_URL + "/api/core/r_docs/";
  ...
  DRUGS_CONTRAINDICATIONS_URL =
    this.HOST_URL + "/api/core/drug_contraindications/";
  ...
  NEWSLETTERS_URL = this.HOST_URL + "/api/core/newsletters/";
  NEWSLETTER_STATE_URL = this.HOST_URL + "/api/core/newsletter_state/";
  SUBSCRIBERS_URL = this.HOST_URL + "/api/core/subscribers/";
}
